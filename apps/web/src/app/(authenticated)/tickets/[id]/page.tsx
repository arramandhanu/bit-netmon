...
import {
    ...
    ChevronRight, Lock, ShieldAlert, RefreshCw,
} from 'lucide-react';
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                    <div className="flex items-start gap-3 flex-1">
                        <Link href="/tickets" className="rounded-lg border border-border/30 p-2 hover:bg-accent transition-colors mt-1 shrink-0">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        {editMode ? (
                            <>
                                ...
                                <button onClick={saveEdit} disabled={saving} className="px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white text-sm font-semibold shadow-lg shadow-cyan-500/20 transition-all flex items-center gap-1.5 disabled:opacity-50">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-card rounded-xl border border-border/30 shadow-sm overflow-hidden">
                            <div className="p-4 border-b border-border/30 bg-accent/30">
                        ...
                        {ticket.attachments && ticket.attachments.length > 0 && (
                            <div className="bg-card rounded-xl border border-border/30 shadow-sm overflow-hidden">
                                <div className="p-4 border-b border-border/30 bg-accent/30 flex items-center gap-2">
                                ...
                                <div className="p-4 space-y-2.5">
                                    {ticket.attachments.map((att: TicketAttachment) => (
                                        <div key={att.id} className="flex items-center justify-between p-3 rounded-lg bg-accent/50 border border-border/30 hover:bg-accent transition-colors">
                        ...
                        <div className="bg-card rounded-xl border border-border/30 shadow-sm overflow-hidden">
                            <div className="p-4 border-b border-border/30 bg-accent/30 flex items-center gap-2">
                                ...
                                <h3 className="font-bold text-sm">Activity ({ticket._count?.comments || 0})</h3>
                            </div>
                                                ...
                                                <div key={c.id} className="relative pl-1 py-2">
                                                    <div className="flex gap-3 ml-0">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            {/* Comment body */}
                                                            <div className="rounded-lg bg-accent/40 border border-border/20 px-4 py-3">
                            ...
                            {/* ── Comment Editor ── */}
                            {canComment ? (
                                <form onSubmit={handleAddComment} className="border-t border-border/30">
                                    <div className="overflow-hidden focus-within:ring-2 focus-within:ring-primary/20 transition-all">
                                        ...
                                        {/* Formatting Toolbar */}
                                        <div className="flex items-center gap-0.5 px-3 py-2 border-b border-border/30 bg-accent/30">
                                        ...
                                        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border/30 bg-accent/20">
                                            <span className="text-[10px] text-muted-foreground">Press ⌘+Enter to submit</span>
                                            <button
                                                type="submit"
                                                disabled={!comment.trim() || submitting}
                                                className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-cyan-500 to-teal-500 px-4 py-1.5 text-xs font-bold text-white hover:from-cyan-600 hover:to-teal-600 transition-all disabled:opacity-50"
                                            >
                                ...
                                <div className="border-t border-border/30 px-5 py-4 bg-accent/20 flex items-center gap-2 text-muted-foreground">
                    ...
                    <div className="space-y-5">
                        ...
                        {/* Ticket Properties */}
                        <div className="bg-card rounded-xl border border-border/30 shadow-sm p-5 space-y-5">
                            ...
                            <div>
                                ...
                                {editMode ? (
                                    ...
                                    <p className="text-sm font-semibold mt-1">{ticket.category.replace('_', ' ')}</p>
                                )}
                            </div>
                        ...
                        {/* Timestamps */}
                        <div className="bg-card rounded-xl border border-border/30 shadow-sm p-5 space-y-2">
